define([
    ...
    Resource.prototype._makeRequest = function(options) {
        ...
        request.requestFunction = function() {
            ...
            var deferred = when.defer();
            // For users of the Resource object that need the status, headers, 
            // and response body for their returned values.
            // If this new property that did not exist before does not 
            // exist in other calls, it does nothing, which should avoid 
            // breaking anyone else's stuff
            var returnType = defaultValue(options.returnType, undefined);
        ...
        xhr.onload = function() {
            ...
            if (returnType !== undefined) {
                ...
                if (returnType === "RAWXHR") {
                    ...
                    var responseHeaders = xhrResponseHeadersToObject(xhr.getAllResponseHeaders());
                    returnValue = {
